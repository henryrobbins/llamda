# Adapted from ReEvo: https://github.com/ai4co/reevo/blob/main/problems/tsp_constructive/gen_inst.py
...
def generate_datasets() -> None:
    ...
    for problem_size in [50]:
        ...
        np.save(
            os.path.join(basepath, f"train{problem_size}_dataset.npy"), test_dataset
        )
